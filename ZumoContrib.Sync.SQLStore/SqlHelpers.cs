...
namespace ZumoContrib.Sync.SQLStore
{
    internal class SqlHelpers
    {
        ...
        public static object SerializeValue(JToken value, string sqlType, JTokenType columnType)
        {
            ...
            switch (sqlType)
            {
                ...
                case SqlColumnType.VarBinaryMax:
                    return SerializeAsBytes(value, columnType);
        ...
        public static JToken ParseBytes(JTokenType jsonType, object value)
        {
            return (byte[])value;
        }
        ...
        public static string GetColumnType(Type type)
        {
            ...
            throw new NotSupportedException(string.Format(CultureInfo.InvariantCulture, Properties.Resources.SqlStore_ValueTypeNotSupported, type.Name));
        }
        ...
        private static void ValidateIdentifier(string identifier)
        {
            ...
            {
                throw new ArgumentException(string.Format(Properties.Resources.SqlStore_InvalidIdentifier, identifier), "identifier");
            }
        }
